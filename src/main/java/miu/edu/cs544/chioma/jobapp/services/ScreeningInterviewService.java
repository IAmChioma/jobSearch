...
import miu.edu.cs544.chioma.jobapp.repository.ScreeningInterviewRepository;
...
public class ScreeningInterviewService {
    ...
    public Job createInterviewInJobApplication(int id, int applicationId, ScreeningInterview interview){
        Job foundJob = jobRepository.findById(id);
        Application applicationFound= applicationRepository.findById(applicationId);
        ScreeningInterview createdInterview = screeningInterviewRepository.save(interview);
    ...
    public String deleteInterviewInApplication(int id,int applicationId, int interviewId){
        Job foundJob = jobRepository.findById(id);
        Application applicationFound= applicationRepository.findById(applicationId);
        ScreeningInterview interviewFound= screeningInterviewRepository.findById(interviewId);
        ...
        screeningInterviewRepository.deleteById(interviewId);
    ...
    public Interview getInterviewInApplication(int id, int applicationId, int interviewId){
        ...
        ScreeningInterview foundInterview= screeningInterviewRepository.findById(interviewId);
    ...
    public List<ScreeningInterview> getAllInterviewInApplication(int id, int applicationId){
        Job foundJob= jobRepository.findById(id);
        Application foundApplication = applicationRepository.findById(applicationId);
        ...
        return screeningInterviewRepository.findAllScreeningInterviewInJobApplication(id,applicationId);

    }
    public Interview updateInterviewApplication(int id,int applicationId,int interviewId, ScreeningInterview interview){
        Job foundJob= jobRepository.findById(id);
        Application foundApplication= applicationRepository.findById(applicationId);
        ScreeningInterview foundInterview= screeningInterviewRepository.findById(interviewId);
        checkForNullApplicationJobInterviewAndThrowException(id, applicationId, interviewId, foundJob, foundApplication, foundInterview);
        ...
        foundInterview.setName(interview.getName());
        foundInterview.setResult(interview.getResult());

        return screeningInterviewRepository.save(foundInterview);
