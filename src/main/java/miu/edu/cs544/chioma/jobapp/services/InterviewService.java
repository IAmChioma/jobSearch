...
public class InterviewService {
    ...
    public Job createInterviewInJobApplication(int id,int applicationId, Interview interview){
    ...
    public String deleteInterviewInApplication(int id,int applicationId, int interviewId){
        Job foundJob = jobRepository.findById(id);
        Application applicationFound= applicationRepository.findById(applicationId);
        Interview interviewFound= interviewRepository.findById(interviewId);
    ...
    public List<Interview> getAllInterviewInApplication(int id, int applicationId){
        Job foundJob= jobRepository.findById(id);
        Application foundApplication = applicationRepository.findById(applicationId);
        ...
        return foundApplication.getInterviews();

    }
    public Interview updateInterviewApplication(int id,int applicationId,int interviewId, Interview interview){
        Job foundJob= jobRepository.findById(id);
        Application foundApplication= applicationRepository.findById(applicationId);
        Interview foundInterview= interviewRepository.findById(interviewId);
        checkForNullApplicationJobInterviewAndThrowException(id, applicationId, interviewId, foundJob, foundApplication, foundInterview);
        ...
        return interviewRepository.save(foundInterview);
